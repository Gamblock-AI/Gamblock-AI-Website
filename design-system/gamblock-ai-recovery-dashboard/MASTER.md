...
- Cyan and azure are quiet informational accents and page washes.
...
- White and near-white surfaces use one-pixel cool borders and soft functional
  shadows. No neumorphism, glass stacks, gradients on controls, or nested card
  towers.
...
- Motion is short and functional: 160-240ms opacity or small translate changes.
  No count-up KPIs, pulsing alerts, bouncing cards, or layout-shifting hover.
...
- Desktop: persistent 248px navigation rail and a quiet top bar.
