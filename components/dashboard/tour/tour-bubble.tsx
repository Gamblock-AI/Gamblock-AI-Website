...
import type { TourRect } from '@/hooks/use-dashboard-tour';
...
/**
 * Shared guided-tour overlay (spotlight + bubble) used by the student and
 * partner dashboard tours. The owning component supplies the tour state, the
 * target step, and the translated copy.
 */
