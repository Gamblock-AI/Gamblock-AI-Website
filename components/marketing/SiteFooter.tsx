      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2.5">
              <Image src="/images/logo.jpg" alt="Gamblock AI" width={32} height={32} className="rounded-md" />
              <span className="text-base font-bold tracking-tight text-white">gamblock ai</span>
            </div>
            <p className="max-w-xs text-sm leading-relaxed text-white/40">
              Sistem pertahanan digital berbasis on-device AI untuk memutus siklus judi online di
            ...
            <div className="flex flex-wrap gap-2 pt-1">
              <span className="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-2.5 py-1 text-[10px] font-bold tracking-wider text-white/60 uppercase">
                <Shield className="h-3 w-3" /> on-device ai
              </span>
              <span className="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-2.5 py-1 text-[10px] font-bold tracking-wider text-white/60 uppercase">
                <Lock className="h-3 w-3" /> patuh uu pdp
              </span>
              <span className="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-2.5 py-1 text-[10px] font-bold tracking-wider text-white/60 uppercase">
                <Brain className="h-3 w-3" /> hybrid ml
              </span>
            </div>
          </div>
        ...
        <div className="mt-12 flex flex-col items-start justify-between gap-4 border-t border-white/10 pt-6 md:flex-row md:items-center">
          <p className="text-xs text-white/30">
            © 2026 gamblock ai · program kreativitas mahasiswa karsa cipta · hak cipta dilindungi
          </p>
