        ...
        <Reveal className="relative z-10 pb-10 lg:pb-14">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="rounded-full border-white/25 bg-transparent text-white hover:bg-white/10 focus-visible:ring-white/70"
            >
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-xs font-semibold text-white/55">
            <span className="inline-flex items-center gap-2">
              <Smartphone className="size-4" /> {t('ctaAndroid')}
            </span>
            <span className="inline-flex items-center gap-2">
              <Monitor className="size-4" /> {t('ctaWindows')}
            </span>
          </div>
        </Reveal>

        <Reveal delay={0.08} className="relative flex h-full min-h-72 items-end justify-center lg:min-h-[25rem]">
          <div className="absolute bottom-0 h-72 w-72 rounded-full bg-sky/15 blur-3xl" aria-hidden />
          <Image
