        ...
        <div className="relative mx-auto flex min-h-[100dvh] max-w-6xl flex-col justify-center px-6 pt-28 md:px-10">
          <Reveal className="max-w-3xl space-y-6">
            <h1 className="text-[11vw] font-bold leading-[0.95] tracking-tighter text-white md:text-7xl">
              kecerdasan yang berjalan
              <br />
              <span className="text-crimson">di dalam perangkat anda.</span>
            </h1>
            <p className="max-w-2xl text-base leading-relaxed text-white/70 md:text-lg">
              pemblokiran konvensional berbasis daftar hitam statis kalah dari situs judi yang berganti domain setiap hari. gamblock ai menjawabnya dengan hybrid analysis dan on-device ai: mendeteksi dari konten halaman, bukan sekadar alamat, semuanya tanpa menyentuh privasi anda.
            </p>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <Reveal className="mb-14 max-w-2xl">
            <h2 className="text-3xl font-bold tracking-tighter text-white md:text-4xl">
              dirancang untuk akurasi, dibangun untuk privasi.
            </h2>
          </Reveal>
      ...
      <section className="relative z-20 border-t border-white/10 bg-black py-24">
        <div className="mx-auto max-w-6xl px-6">
          <Reveal className="mb-12 max-w-2xl">
            <h2 className="text-3xl font-bold tracking-tighter text-white md:text-4xl">
              dari akses hingga blokir, dalam milidetik.
            </h2>
          </Reveal>
      ...
      <section className="relative z-20 border-t border-white/10 bg-neutral-950 py-24">
        <Reveal className="mx-auto max-w-3xl space-y-6 px-6 text-center">
          <h2 className="text-3xl font-bold tracking-tighter text-white md:text-5xl">
            ...
            <br />
            <span className="text-crimson">melindungi tanpa henti.</span>
          </h2>
          <p className="text-base text-white/65 md:text-lg">
            tanpa data dikirim, tanpa performa terganggu. rasakan deteksi cerdas yang menghormati privasi anda.
          </p>
          <Link href={ROUTES.REGISTER}>
