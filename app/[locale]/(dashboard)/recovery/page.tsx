    ...
    <div className="w-full space-y-4">
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <div className="space-y-4 lg:col-span-2">
          {/* New Entry */}
          <Card className="p-5">
            <h3 className="text-sm font-extrabold text-navy">{t('text_191')}</h3>
            <form onSubmit={handleAddEntry} className="mt-3 space-y-3">
              <textarea
                value={newText}
                onChange={(e) => setNewText(e.target.value)}
                placeholder={t('text_202')}
          ...
          {/* Journal History */}
          <Card className="p-5">
            <h3 className="text-sm font-extrabold text-navy">{t('text_192')}</h3>
        ...
        <div className="space-y-4">
          ...
          <Card className="p-5">
            <div className="mb-3 flex items-center gap-3">
              ...
              <h3 className="text-sm font-extrabold tracking-wider text-navy uppercase">{t('text_193')}</h3>
            </div>
            <div className="space-y-3">
              <div className="rounded-xl border border-border bg-muted/30 p-4">
                <p className="text-xs leading-relaxed font-semibold text-muted-foreground italic">
                  {t('text_194')}{intention}{t('text_195')}</p>
              </div>
              <div className="space-y-3 text-xs">
                ...
                <div className="flex justify-between">
                  <span className="font-medium text-muted-foreground">{t('text_196')}</span>
          ...
          <Card className="p-5">
            <div className="space-y-1 mb-4">
              <h3 className="text-sm font-extrabold text-navy">{t('text_197')}</h3>
            ...
            {submittedCheckin ? (
              <div className="rounded-xl border border-sage/20 bg-sage/5 p-5 text-center">
                ...
                <p className="mt-2 text-xs font-bold text-sage">{t('text_199')}</p>
              ...
              <div className="space-y-3">
                ...
                >
                  {t('text_201')}<CheckCircle className="h-3.5 w-3.5" />
                </button>
              </div>
            )}
          </Card>
