        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {EXTERNAL_SKILL_PLATFORMS.map((platform) => (
            <a
              ...
              className="border-border bg-card shadow-soft hover:border-navy/30 hover:shadow-card focus-visible:ring-navy/30 group flex min-h-11 flex-col rounded-2xl border p-5 transition-[border-color,box-shadow] outline-none focus-visible:ring-2 motion-reduce:transition-none"
            >
              ...
              <span className="text-navy group-hover:text-navy-light mt-4 inline-flex items-center gap-1.5 text-sm font-semibold">
                {t('openPlatform')}
