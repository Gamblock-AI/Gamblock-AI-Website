  ...
  return (
    <div className="w-full space-y-3">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-sm font-semibold tracking-tight">Panel Kontrol Admin</h1>
          <p className="text-xs font-semibold text-muted-foreground">
            Kelola modul psikoedukasi, rilis model AI, tiket bantuan, dan kunci darurat.
          </p>
        </div>
      </div>
      ...
      <Tabs defaultValue="konten" className="w-full">
        <TabsList className="mb-2 flex w-fit gap-1 rounded-xl border border-border bg-muted/60 p-1">
          ...
          <TabsTrigger value="releases" className="flex cursor-pointer items-center gap-1.5 rounded-xl px-4 py-2.5 text-xs font-bold">
            <Terminal className="size-4" /> Rilis AI
          </TabsTrigger>
          ...
          <TabsTrigger value="emergency" className="flex cursor-pointer items-center gap-1.5 rounded-xl px-4 py-2.5 text-xs font-bold">
            <Key className="size-4" /> Kunci Darurat
          </TabsTrigger>
        </TabsList>

        {loading ? (
          <div className="flex items-center justify-center gap-1.5 py-12 text-center text-xs font-semibold text-muted-foreground">
            <Clock className="size-4 animate-spin" /> Memuat data...
          </div>
        ) : (
          <>
            <TabsContent value="konten" className="space-y-3 rounded-lg border border-border bg-card p-4">
              <h3 className="text-base font-black text-navy">Manajemen Modul Psikoedukasi</h3>
              <Table>
            ...
            <TabsContent value="releases" className="space-y-3 rounded-lg border border-border bg-card p-4">
              <h3 className="text-base font-black text-navy">Rilis Model AI Pertahanan</h3>
              <Table>
            ...
            <TabsContent value="support" className="space-y-3 rounded-lg border border-border bg-card p-4">
              <h3 className="text-base font-black text-navy">Tiket Dukungan</h3>
              <Table>
            ...
            {/* Emergency Key Tab */}
            <TabsContent value="emergency" className="space-y-4 rounded-lg border border-border bg-card p-4">
              <h3 className="text-base font-black text-navy">Kunci Darurat (Emergency Master Key)</h3>
              <p className="text-xs text-muted-foreground">
                Kunci darurat bersifat satu kali pakai dan berlaku 24 jam. Gunakan hanya jika WhatsApp Kepala mengalami gangguan permanen.
              </p>
                ...
                <Card className="border-amber/30 bg-amber/[0.03] p-5">
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-label text-amber">Kunci Darurat Dihasilkan</span>
                    </div>
                    ...
                    <div className="flex items-center gap-2 text-xs text-muted-foreground">
                      ...
                      Berlaku 24 jam - satu kali pakai
                    </div>
                  </div>
                </Card>
              ) : (
