      ...
      <div className="rounded-lg border border-slate-100 bg-white p-4 shadow-[0_4px_20px_rgba(0,0,0,0.01)]">
        <div className="space-y-1">
          ...
          <h1 className="text-navy mt-2 text-xl font-bold tracking-tight">
            Pengaturan Proteksi ⚙️
          </h1>
          <p className="text-sm text-slate-500">
            Kelola ambang batas sensitivitas kecerdasan buatan, aksesibilitas
            sistem, dan parameter akun pendamping.
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSave} className="space-y-3">
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="space-y-1">
                  <h4 className="text-navy text-sm font-bold">
                    Kunci Proteksi (Anti-Uninstall)
                  </h4>
                  <p className="text-[11px] leading-relaxed text-slate-400">
                    Mencegah aplikasi dimatikan paksa atau dihapus tanpa
                    persetujuan dari Akun Pendamping.
                  </p>
                </div>
        ...
        {partnerStatus === 'none' && (
          <div className="flex justify-end pt-2">
            ...
            >
              Undang Pendamping & Simpan <Save className="size-4" />
            </button>
          </div>
        )}
      </form>
