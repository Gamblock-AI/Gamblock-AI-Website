    ...
    <div className="w-full space-y-4">
      ...
      <Card className="border-navy/10 bg-navy/[0.02] p-5">
        ...
        <h1 className="mt-2 text-xl font-extrabold tracking-tight text-navy">
          Psikoedukasi & Regulasi Diri
        </h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Materi edukasi dan latihan psikologis mandiri terstruktur yang didesain berdasarkan Self-Regulation Theory.
        </p>
      </Card>
                ...
                <div className="space-y-2 border-t border-border pt-3">
                  ...
                  <div className="flex justify-end">
                    <span className="inline-flex items-center gap-1 text-xs font-bold text-navy group-hover:underline">
                      Buka Modul <ArrowRight className="h-3 w-3 transition-transform group-hover:translate-x-0.5" />
                    </span>
                  </div>
                </div>
              </div>
