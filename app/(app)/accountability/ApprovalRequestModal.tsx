      ...
      <div className="text-navy relative w-full max-w-md space-y-3 rounded-lg bg-white p-4 shadow-2xl">
        ...
        <div className="space-y-3 text-center md:text-left">
          ...
          <h3 className="text-navy pt-2 text-sm font-semibold tracking-tight">
            Persetujuan Pendamping Diperlukan
          </h3>
          <p className="text-xs leading-relaxed font-semibold text-slate-500">
            Berdasarkan protokol akuntabilitas sosial, tindakan menonaktifkan
            Kunci Proteksi memerlukan otorisasi persetujuan dari pendamping
            Anda. Silakan isi alasan Anda di bawah ini.
          </p>
        </div>
        ...
        <form onSubmit={onSubmit} className="space-y-3">
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              placeholder="Mengapa Anda ingin menonaktifkan proteksi ini? (Tulis alasan yang jujur untuk pendamping Anda)..."
              rows={3}
