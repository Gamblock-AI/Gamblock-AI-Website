  ...
  return (
    <div className="text-navy w-full space-y-4">
      ...
      <div className="rounded-lg border border-slate-100 bg-white p-4 shadow-[0_4px_20px_rgba(0,0,0,0.01)]">
        <div className="space-y-1">
          ...
          <p className="text-sm text-slate-500">
            Perbarui informasi data diri Anda dan ubah kata sandi akun.
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {/* Update Data Diri */}
        <div className="space-y-4 rounded-lg border border-slate-100 bg-white p-4 shadow-[0_4px_20px_rgba(0,0,0,0.01)]">
          ...
          <form onSubmit={handleUpdateProfile} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="focus:ring-navy w-full rounded-xl border border-slate-200 bg-white py-2.5 pr-4 pl-12 text-xs font-semibold text-slate-900 placeholder-slate-400 shadow-sm focus:border-transparent focus:ring-2 focus:outline-none"
            ...
            <div className="flex justify-end pt-2">
              <button
                type="submit"
                disabled={loading}
                className="bg-navy hover:bg-navy/90 flex cursor-pointer items-center justify-center gap-1.5 rounded-full px-6 py-2.5 text-xs font-bold text-white shadow-md shadow-blue-500/5 transition-all disabled:opacity-50"
              >
                Simpan Profil <Save className="size-4" />
              </button>
            </div>
          </form>
        </div>
          ...
          <form onSubmit={handleUpdatePassword} className="space-y-4">
            ...
            <div className="flex justify-end pt-2">
              <button
                ...
                className="bg-navy hover:bg-navy/90 flex cursor-pointer items-center justify-center gap-1.5 rounded-full px-6 py-2.5 text-xs font-bold text-white shadow-md shadow-blue-500/5 transition-all disabled:opacity-50"
              >
                Ubah Password <Save className="size-4" />
              </button>
            </div>
          </form>
        </div>
